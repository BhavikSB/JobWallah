    ...
    return (
        <div className="flex sm-mx:flex-col-reverse  items-center px-16 bs-mx:px-10 md-mx:px-5">
            <div data-aos="zoom-out-right" className="flex flex-col w-[45%] sm-mx:w-full gap-3">
                <br/>
                <div className="text-6l bs-mx:text-5l md-mx:text-4l sm-mx:text-3l font-bold leading-tight text-mine-shaft-100 [&>span]:text-bright-sun-400">Connecting <span >Talent</span> with <span>Opportunity</span></div>
                ...
                <div className="text-6l bs-mx:text-5l md-mx:text-4l sm-mx:text-3l font-bold leading-tight text-mine-shaft-100 [&>span]:text-bright-sun-400">The Right <span >Job</span> is waiting for you,<span> Connect with Us </span></div>
                
                <div className="text-lg md-mx:text-base sm-mx:text-sm text-mine-shaft-200">A great career starts with the right company. Discover thousands of opportunities, all in one place.</div>
