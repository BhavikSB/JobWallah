...
const Working = () => {
    return <div className="mt-20 pb-5 overflow-hidden">
        <div data-aos="zoom-out" className="text-4xl  md-mx:text-3xl sm-mx:text-2xl xs-mx:text-xl text-center font-semibold mb-3 text-mine-shaft-100">Your <span className="text-bright-sun-400">Path</span> to a <span className="text-bright-sun-400">New Job</span></div>
        ...
        <div className="flex px-16 bs-mx:px-10 gap-2 md-mx:flex-col md-mx:px-5 justify-between items-center ">
            <div data-aos="fade-right" className="relative">
                <img className="w-[38rem]" src="/Working/Girl.png" alt="girl" />
